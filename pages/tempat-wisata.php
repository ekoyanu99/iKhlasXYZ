...
<body>
    ...
    <section class="h-100 w-100 bg-white" style="box-sizing: border-box">
        <div class="container">
            <h2>Preview Benowo Park</h2>
            <!-- Benowo Park -->
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true" rounded>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img width="560" height="315" src="<?= BASE_URL . '/img/preview/benowo-park-1.jpg' ?>" alt="..." />
                    </div>
                    <div class="carousel-item">
                        <div class="embed-responsive embed-responsive-video">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/I-a-Ibo3bAM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
